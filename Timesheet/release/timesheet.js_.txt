...
$(document).ready(function(){
	...
	$("#add-event-button").click(function() {
		...
		var html_tr = '<tr id='+tr_id+'>'+ 
					  ...
					  '</tr>'
		$("#data-container-body").append(html_tr);
		unique_id++;
	});
...
$(document).ready(function(){
	...
	$("#generate-timesheet").click(function() {
		...
		// Getting final version of #data-container-body table and
		//	add "start time in minutes" and "end time in minutes" to the array.
		$("#data-container-body > tr").each(function() {
			
			// Get all data from data-container-body table.
